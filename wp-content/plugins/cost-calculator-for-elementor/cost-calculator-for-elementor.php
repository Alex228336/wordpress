...
if (!defined('ELEMENTOR_COST_CALCULATOR_PLUGIN_PATH')) {
    ...
    class Eelementor_Cost_Calculator_Init {
        ...
        function add_lib_backend(){
            ...
            $datas_done = apply_filters( "yeeaddons_elementor_settings_fs", $datas_done,$datas);
        ...
        function add_lib(){
            wp_enqueue_script(
                ...
                wp_localize_script( "elementor_calculator", "elementor_calculator", array("data"=>get_option( '_redmuber_item_1529')) );
                wp_enqueue_style(
                    'elementor-calculator',
