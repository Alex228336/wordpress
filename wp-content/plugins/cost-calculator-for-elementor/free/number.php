...
class Number_Format_Cost_Calculator_Widget extends \Elementor\Widget_Base{
	...
	protected function render() {
		...
		?>
		<input <?php echo esc_attr($atts) ?> value="<?php echo esc_attr($settings["default"])  ?>" class="<?php echo esc_attr($class) ?>" type="text" name="<?php echo esc_attr($name) ?>" id="<?php echo esc_attr($name) ?>">
		<?php
	}
}